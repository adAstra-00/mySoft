...
export const Heroes = () => {
    return (
        <div className="flex items-center justify-center">
            ...
            <div id="heroes-rel-ctnr-lm" className="relative w-[300px] h-[300px] md:w-[400px] md:h-[400px] m-2">
            ...
            <div id="heroes-rel-ctnr-dm" className="relative w-[300px] h-[300px] md:w-[400px] md:h-[400px] m-2 hidden md:block">
