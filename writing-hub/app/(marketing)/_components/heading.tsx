...
export const Heading = () => {
    return (
        <div className="bg-orange-400 flex p-2 h-full">
            <div className="bg-yellow-200 w-full">
                <h1 className="font-bold p-2" style={{
    fontSize: "clamp(1rem, 2vw, 2.5rem)", /*adjust min, preferred, max sizes*/ }}>
                ...
                <div className="flex flex-row items-center justify-center w-full">
                    <h3 className="text-blue-400 font-medium m-2">
